...
public class Server {
    ...
    public static void main(String[] args) {
        dotenv = Dotenv.configure().directory(Paths.get(Paths.get("").toAbsolutePath().toString(), "config").toString()).load();
        port(dotenv.get("PORT", Integer.class));
        dotenv.get("SUCCESS_STATUS_CODE", Integer.class);
